...
WebUI.setText(findTestObject('Object Repository/input__erbke'), contractTemplateName+'.zip')

WebUI.setText(findTestObject('Object Repository/input__lshze'), contractTemplateName)
