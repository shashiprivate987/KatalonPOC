...
//Verify Item from Sourcing to CLID having no APC set
TestObject obj7 = new TestObject("apc locator7")
String noAPCPrice = "//input[@awname='0.2_PRICEPrice::PRICE:shortMoneyString']"
obj7.addProperty("xpath", ConditionType.EQUALS, noAPCPrice)
