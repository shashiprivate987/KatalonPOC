...
WebUI.setText(findTestObject('Object Repository/input__erbke'), rfpTemplateName+'.zip')

WebUI.setText(findTestObject('Object Repository/input__lshze'), rfpTemplateName)
