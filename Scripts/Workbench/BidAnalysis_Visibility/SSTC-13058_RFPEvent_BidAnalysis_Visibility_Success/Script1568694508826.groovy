...
// Create RFP event
WebUI.callTestCase(findTestCase('Workbench/UtilTests/CreateSourcingEvent'), [('NewUserName') : 'OWBAutomationUser01', ('templateName') : templateName
        , ('eventName') : 'BidAnalysis_Visibility_Success', ('eventContentExcel') : eventContentExcel], FailureHandling.STOP_ON_FAILURE)
...
//verification
boolean BA = WebUI.verifyElementPresent(findTestObject('Optimization_Workbench_Object_Repo/Page_Ariba Spend Management/a_Bid Analysis'), 
    3, FailureHandling.OPTIONAL)

if (BA) {
    WebUI.refresh()

    WebUI.comment('Bid Analysis tab is visible on the event content page')

    CustomKeywords.'common.util.aribakeywords.aribaClick'(findTestObject('Object Repository/Optimization_Workbench_Object_Repo/Page_Ariba Spend Management/a_Bid Analysis'))
    ...
    WebUI.comment('Bid Analysis tab is not visible on the event content page')
}
