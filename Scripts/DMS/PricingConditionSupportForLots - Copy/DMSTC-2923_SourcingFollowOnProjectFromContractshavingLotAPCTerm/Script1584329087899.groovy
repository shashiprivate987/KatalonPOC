...
String SAVE_TO_DRAFT = "//button[@aawname='ModalPageWrapper:okClicked_1' and @title='Save as Draft']"
...
TestObject saveTodraft = Ariba.createTestObject(SAVE_TO_DRAFT)
Ariba.aribaClick(saveTodraft)


/**
 * Publish contract CLID
 */
...
/**
 * Create follow On Sourcing Project
 */

//TODO: Check the locator correctness of below steps

WebUI.click(findTestObject('Object Repository/span_Overview_w-pml-icon'))

WebUI.click(findTestObject('Object Repository/ActionTilt Contract TermsContract Workspace'))

WebUI.click(findTestObject('Object Repository/a_Sourcing Project'))

WebUI.setText(findTestObject('Object Repository/input___ihgt1d'), 'FollowOnProject')

WebUI.click(findTestObject('Object Repository/div_No ChoiceNo ChoiceRFIRFPAuctionForward Auction'))

WebUI.click(findTestObject('Object Repository/div_Create Sourcing followOn Project'))

WebUI.click(findTestObject('Object Repository/label_Yes_w-rdo w-rdo-dsize'))

WebUI.click(findTestObject('Object Repository/label_Basket Lot template for APC_w-rdo w-rdo-dsize'))

WebUI.click(findTestObject('Object Repository/span_Create'))

WebUI.click(findTestObject('Object Repository/a_Content'))


//TODO: Add Verification steps for Lot and Lot APC Term from contract
