...
if(featureToggleName instanceof List){
	flag = true;
} else{
	flag = false;
}
...
if(flag){
	for(int i=0; i< featureToggleName.size(); i++){
		
		println featureToggleName.get(i).toString();
	}
}else{
	println featureToggleName;
...
WebUI.setText(findTestObject('Object Repository/input_Full Qualified Name of F'), featureToggleName)
